<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">{{ __( 'template.banners' ) }}</h3>
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        <li class="nk-block-tools-opt">
                            <a href="{{ route( 'admin.banner.add' ) }}" class="btn btn-primary">{{ __( 'template.add' ) }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
$columns = [
    ...
    [
        'type' => 'input',
        'placeholder' =>  __( 'datatables.search_x', [ 'title' => __( 'banner.name' ) ] ),
        'id' => 'name',
...
<x-data-tables id="banner_table" enableFilter="true" enableFooter="false" columns="{{ json_encode( $columns ) }}" />
...
var statusMapper = @json( $data['status'] ),
    ...
    dt_table_config = {
        ...
        ajax: {
            url: '{{ route( 'admin.banner.allBanners' ) }}',
            data: {
                '_token': '{{ csrf_token() }}',
            },
            dataSrc: 'banners',
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function( data, type, row, meta ) {
                    ...
                    @canany( [ 'edit banners', 'delete banners' ] )
    ...
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        $( document ).on( 'click', '.dt-status', function() {
            ...
            $.ajax( {
                url: '{{ route( 'admin.banner.updateBannerStatus' ) }}',
                type: 'POST',
                data: {
                    'id': $( this ).data( 'id' ),
