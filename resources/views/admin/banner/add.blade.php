            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade pt-4 show active" id="en_name" role="tabpanel" aria-labelledby="en_name-tab">
                        <div class="mb-3 row">
                            <label for="{{ $banner_create }}_en_name" class="col-sm-4 col-form-label">{{ __( 'banner.name' ) }} ( English )</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="{{ $banner_create }}_en_name">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="{{ $banner_create }}_en_desc" class="col-sm-4 col-form-label">{{ __( 'banner.desc' ) }} ( English )</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="{{ $banner_create }}_en_desc">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade pt-4" id="zh_name" role="tabpanel" aria-labelledby="zh_name-tab">
                        <div class="mb-3 row">
                            <label for="{{ $banner_create }}_zh_name" class="col-sm-4 col-form-label">{{ __( 'banner.name' ) }} ( 中文 )</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="{{ $banner_create }}_zh_name">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="{{ $banner_create }}_zh_desc" class="col-sm-4 col-form-label">{{ __( 'banner.desc' ) }} ( 中文 )</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="{{ $banner_create }}_zh_desc">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-end">
                    <button id="{{ $banner_create }}_cancel" type="button" class="btn btn-outline-secondary">{{ __( 'template.cancel' ) }}</button>
                    &nbsp;
                    <button id="{{ $banner_create }}_submit" type="button" class="btn btn-primary">{{ __( 'template.save_changes' ) }}</button>
                </div>
            </div>
        </div>
    </div>
...
window.cke_element = [ 'banner_create_en_name', 'banner_create_zh_name', 'banner_create_en_desc', 'banner_create_zh_desc' ];
</script>
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        $( dc + '_submit' ).click( function() {
            ...
            formData.append( 'en_name', editors['banner_create_en_name'].getData()  );
            formData.append( 'zh_name', editors['banner_create_zh_name'].getData() );
            formData.append( 'en_desc', editors['banner_create_en_desc'].getData()  );
            formData.append( 'zh_desc', editors['banner_create_zh_desc'].getData() );
