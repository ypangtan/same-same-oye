...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">{{ __( 'template.add_x', [ 'title' => Str::singular( __( 'template.categories' ) ) ] ) }}</h3>
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade pt-4 show active" id="en_name" role="tabpanel" aria-labelledby="en_name-tab">
                        <div class="mb-3 row">
                            <label for="{{ $category_create }}_en_name" class="col-sm-4 col-form-label">{{ __( 'category.name' ) }} </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="{{ $category_create }}_en_name">
                    ...
                    <div class="tab-pane fade pt-4" id="zh_name" role="tabpanel" aria-labelledby="zh_name-tab">
                        <div class="mb-3 row">
                            <label for="{{ $category_create }}_zh_name" class="col-sm-4 col-form-label">{{ __( 'category.name' ) }} ( 中文 )</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="{{ $category_create }}_zh_name">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-3 row">
                    <label for="{{ $category_create }}_color" class="col-sm-4 col-form-label">{{ __( 'category.color' ) }}</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control col-sm-4" id="{{ $category_create }}_color" autocomplete="off">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="text-end">
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        let dc = '#{{ $category_create }}',
            fileID = '';
            
        const $cp = $( dc + '_color' ).colorpicker({
            appendTo: 'body',
            hideButton: false
        });
        ...
        $( dc + '_submit' ).click( function() {
            ...
            formData.append( 'color', $( dc + '_color').val() );
