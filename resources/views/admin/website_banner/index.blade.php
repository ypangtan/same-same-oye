<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">{{ __( 'template.website_banners' ) }}</h3>
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        <li class="nk-block-tools-opt">
                            <a href="{{ route( 'admin.website_banner.add' ) }}" class="btn btn-primary">{{ __( 'template.add' ) }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
$columns = [
    ...
    [
        'type' => 'default',
        'id' => 'image',
        'title' => __( 'website_banner.image' ),
    ],
    [
        'type' => 'input',
        'placeholder' =>  __( 'datatables.search_x', [ 'title' => __( 'website_banner.name' ) ] ),
        'id' => 'name',
        'title' => __( 'website_banner.name' ),
    ],
    [
        'type' => 'select',
        'options' => $data['status'],
...
<x-data-tables id="website_banner_table" enableFilter="true" enableFooter="false" columns="{{ json_encode( $columns ) }}" />
...
var statusMapper = @json( $data['status'] ),
    dt_table,
    dt_table_name = '#website_banner_table',
    dt_table_config = {
        language: {
        ...
        ajax: {
            url: '{{ route( 'admin.website_banner.allWebsiteBanners' ) }}',
            data: {
                '_token': '{{ csrf_token() }}',
            },
            dataSrc: 'website_banners',
        },
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function( data, type, row, meta ) {
                    ...
                    @canany( [ 'edit website_banners', 'delete website_banners' ] )
    ...
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        $( document ).on( 'click', '.dt-status', function() {
            ...
            $.ajax( {
                url: '{{ route( 'admin.website_banner.updateWebsiteBannerStatus' ) }}',
                type: 'POST',
                data: {
                    'id': $( this ).data( 'id' ),
