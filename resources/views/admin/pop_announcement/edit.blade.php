                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade pt-4 show active" id="en_title" role="tabpanel" aria-labelledby="en_title-tab">
                                <div class="mb-3 row">
                                    <label for="{{ $pop_announcement_edit }}_en_title" class="col-sm-5 col-form-label">{{ __( 'pop_announcement.title' ) }} </label>
                                    <div class="col-sm-7">
                                ...
                                <div class="mb-3 row">
                                    <label for="{{ $pop_announcement_edit }}_en_text" class="col-sm-5 col-form-label">{{ __( 'pop_announcement.text' ) }} </label>
                                    <div class="col-sm-7">
