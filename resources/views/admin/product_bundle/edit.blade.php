...
<?php
$product_bundle_edit = 'product_bundle_edit';
?>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="mb-3">
                    ...
                    <div class="dropzone mb-3" id="{{ $product_bundle_edit }}_image" style="min-height: 0px;">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_bundle_edit }}_title" class="col-sm-5 form-label">{{ __( 'product.title' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="{{ $product_bundle_edit }}_title">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                
                <div class="mb-3 row">
                    <label for="{{ $product_bundle_edit }}_code" class="col-sm-5 form-label">{{ __( 'product.code' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="{{ $product_bundle_edit }}_code">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="{{ $product_bundle_edit }}_description" class="col-sm-5 form-label">{{ __( 'product.description' ) }}</label>
                    <div class="col-sm-7">
                        <textarea class="form-control" name="{{ $product_bundle_edit }}_description" id="{{ $product_bundle_edit }}_description" rows="5"></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="number" class="form-control" id="{{ $product_bundle_edit }}_price">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="{{ $product_bundle_edit }}_discount_price" class="col-sm-5 form-label">{{ __( 'product.discount_price' ) }}</label>
                    <div class="col-sm-7">
                        <input type="number" class="form-control" id="{{ $product_bundle_edit }}_discount_price">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                
                <div class="mb-3 row">
                    <label for="{{ $product_bundle_edit }}_product" class="col-sm-5 form-label">{{ __( 'product_bundle.product' ) }}</label>
                    <div class="col-sm-7">
                        <select class="form-select" id="{{ $product_bundle_edit }}_product" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'product_bundle.product' ) ] ) }}" multiple="multiple">
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                ...
                <div class="text-end">
                    ...
                    &nbsp;
                    <button id="{{ $product_bundle_edit }}_submit" type="button" class="btn btn-primary">{{ __( 'template.save_changes' ) }}</button>
                </div>
            </div>
        </div>
    </div>
...
window.cke_element1 = 'product_bundle_edit_description';
</script>
            ...
            $.ajax( {
                ...
                success: function( response ) {
                    ...
                    response.product_bundle_metas.forEach((product, index) => {
                        let option1 = new Option( product.product.title, product.product.id, true, true );
