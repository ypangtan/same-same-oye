...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">{{ __( 'template.add_x', [ 'title' => Str::singular( __( 'template.quotations' ) ) ] ) }}</h3>
    ...
    <div class="card-inner">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_warehouse" class="col-sm-5 form-label">{{ __( 'template.warehouses' ) }}</label>
                        <div class="col-sm-7">
                            <select class="form-select" id="{{ $quotation_create }}_warehouse" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'template.warehouses' ) ] ) }}">
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
                </div>
                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_supplier" class="col-sm-5 form-label">{{ __( 'template.suppliers' ) }}</label>
                        <div class="col-sm-7">
                            <select class="form-select" id="{{ $quotation_create }}_supplier" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'template.suppliers' ) ] ) }}">
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
                </div>
                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_customer" class="col-sm-5 form-label">{{ __( 'template.customers' ) }}</label>
                        <div class="col-sm-7">
                            <select class="form-select" id="{{ $quotation_create }}_customer" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'template.customers' ) ] ) }}">
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
                </div>
                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_salesman" class="col-sm-5 form-label">{{ __( 'template.salesmen' ) }}</label>
                        <div class="col-sm-7">
                            <select class="form-select" id="{{ $quotation_create }}_salesman" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'template.salesmen' ) ] ) }}">
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
                </div>
                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_product" class="col-sm-5 form-label">{{ __( 'template.products' ) }}</label>
                    <div class="col-sm-7">

                        <select class="form-select" id="{{ $quotation_create }}_product" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'template.products' ) ] ) }}" multiple="multiple">
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="dropzone mb-3" id="{{ $quotation_create }}_attachment" style="min-height: 0px;">
                ...
                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_tax_method" class="col-sm-5 col-form-label">{{ __( 'product.tax_method' ) }}</label>
                    <div class="col-sm-7">
                        <select class="form-select" id="{{ $quotation_create }}_tax_method" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'product.tax_method' ) ] ) }}">
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_discount" class="col-sm-5 col-form-label">{{ __( 'quotation.discount' ) }}</label>
                    <div class="col-sm-7">
                        <input class="form-control" type="number" name="{{ $quotation_create }}_discount" id="{{ $quotation_create }}_discount">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_shipping_cost" class="col-sm-5 col-form-label">{{ __( 'quotation.shipping_cost' ) }}</label>
                    <div class="col-sm-7">
                        <input class="form-control" type="number" name="{{ $quotation_create }}_shipping_cost" id="{{ $quotation_create }}_shipping_cost">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="{{ $quotation_create }}_remarks" class="col-sm-5 col-form-label">{{ __( 'quotation.remarks' ) }}</label>
                    <div class="col-sm-7">
                        <textarea class="form-control" id="{{ $quotation_create }}_remarks"></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="text-end">
                    <button id="{{ $quotation_create }}_cancel" type="button" class="btn btn-outline-secondary">{{ __( 'template.cancel' ) }}</button>
                    &nbsp;
                    <button id="{{ $quotation_create }}_submit" type="button" class="btn btn-primary">{{ __( 'template.save_changes' ) }}</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        let fc = '#{{ $quotation_create }}',
                fileID = '';

        $( fc + '_quotation_date' ).flatpickr( {
            disableMobile: true,
            defaultDate: 'today',
        } );
        ...
        $( fc + '_submit' ).click( function() {
            ...
            $.ajax( {
                url: '{{ route( 'admin.quotation.createQuotation' ) }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType:   false,
