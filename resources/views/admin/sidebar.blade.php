                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                <li class="nk-menu-item {{ $controller == 'App\Http\Controllers\Admin\DashboardController' ? 'active current-page' : '' }}">
                                    <a href="{{ route( 'admin.module_parent.dashboard' ) }}" class="nk-menu-link">
                                ...
                                <li class="nk-menu-item has-sub {{ ($controller == 'App\Http\Controllers\Admin\MarketingNotificationController' || $controller == 'App\Http\Controllers\Admin\PopAnnouncementController') ? 'active current-page' : '' }}">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item {{ $controller == 'App\Http\Controllers\Admin\MarketingNotificationController' && in_array( $action, [ 'index', 'edit', 'add' ] ) ? 'active current-page' : '' }}">
