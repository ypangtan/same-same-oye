                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade pt-4 show active" id="en_title" role="tabpanel" aria-labelledby="en_title-tab">
                                <div class="mb-3 row">
                                    <label for="{{ $announcement_create }}_en_title" class="col-sm-5 col-form-label">{{ __( 'announcement.title' ) }} ( English )</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" id="{{ $announcement_create }}_en_title">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="{{ $announcement_create }}_en_description" class="col-sm-5 col-form-label">{{ __( 'announcement.description' ) }} ( English )</label>
                                    <div class="col-sm-7">
                                        <textarea class="form-control"  style="min-height: 80px;" id="{{ $announcement_create }}_en_description"></textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade pt-4" id="zh_title" role="tabpanel" aria-labelledby="zh_title-tab">
                                <div class="mb-3 row">
                                    <label for="{{ $announcement_create }}_zh_title" class="col-sm-5 col-form-label">{{ __( 'announcement.title' ) }} ( 中文 )</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" id="{{ $announcement_create }}_zh_title">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="{{ $announcement_create }}_zh_description" class="col-sm-5 col-form-label">{{ __( 'announcement.description' ) }} ( 中文 )</label>
                                    <div class="col-sm-7">
                                        <textarea class="form-control"  style="min-height: 80px;" id="{{ $announcement_create }}_zh_description"></textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
...
window.cke_element = [ 'announcement_create_en_description', 'announcement_create_zh_description' ];
</script>
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        $( fc + '_submit' ).click( function() {
            ...
            formData.append( 'en_description', editors['announcement_create_en_description'].getData() );
            formData.append( 'zh_description', editors['announcement_create_zh_description'].getData() );
