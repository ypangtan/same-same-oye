                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade pt-4 show active" id="en_title" role="tabpanel" aria-labelledby="en_title-tab">
                                <div class="mb-3 row">
                                    <label for="{{ $announcement_create }}_en_title" class="col-sm-5 col-form-label">{{ __( 'announcement.title' ) }} </label>
                                    <div class="col-sm-7">
                                ...
                                <div class="mb-3 row">
                                    <label for="{{ $announcement_create }}_en_description" class="col-sm-5 col-form-label">{{ __( 'announcement.description' ) }} </label>
                                    <div class="col-sm-7">
